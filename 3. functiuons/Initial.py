...
parm = {
 #-------------------------------------------------------------------------
    ...
    'logShow' : 2,  # {0, 1, 2}, 0: no log, 1: basic logs, 2: detail 

 #----------------------------------------------------------------------------------------       
    # 訊號來源處理    
    
    'sourDir' : DATA_ROOT + SOURCE_PATH,
    'sFile': DATA_ROOT+TARGET_PATH+'Merged.csv',     # raw signal file name (訊號來源檔)
    ...
    'pFile': DATA_ROOT+TARGET_PATH+'Parsed.csv',      # parsed data file name (解譯檔)
 ...
 #------------------------------------------------------------------------------------------   
    # 訊號特徵化處理
    'fFile': DATA_ROOT+TARGET_PATH+'Features.xlsx',   # feature file name     (特徵檔)
