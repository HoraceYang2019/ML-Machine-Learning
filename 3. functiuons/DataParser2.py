...
if __name__ == '__main__':
    ...
    po = Parser(index = parm['tNo'], timeTag = parm['timeTag'], logShow = parm['logShow'])
    s2 = po.fit_transform() # sheet name of the target file, return raw data list with time tag
